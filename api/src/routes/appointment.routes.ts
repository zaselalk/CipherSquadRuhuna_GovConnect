...
const upload = multer({ dest: "uploads/" }); // or use diskStorage for custom path
...
AppointmentRoutes.post("/with-documents", upload.array("documents"), catchAsync(appointmentController.createAppointmentWithDocuments));
