...
const CitizenDashboardPage = () => {
  ...
  const handleBookNew = () => navigate("/citizen/departments");
  ...
  return (
    <Layout className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-600 ">
      <CommonNav />
      <Content style={{ paddingLeft: 100, paddingRight: 100 }} className="py-12 overflow-auto" aria-label="Citizen Dashboard Content">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <Badge count={notifications.length} overflowCount={99} style={{ backgroundColor: "#2563eb", cursor: "pointer" }}>
                <Button shape="circle" type="text" icon={<BellOutlined style={{ color: "#2563eb", fontSize: 20 }} />} aria-label="Toggle notifications" />
              </Badge>
            </Popover>

            <Button type="primary" icon={<PlusOutlined />} onClick={handleBookNew} className="font-semibold rounded-md shadow-md hover:shadow-lg transition-shadow" style={{ padding: "8px 20px", minHeight: 40 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <section style={sectionCardStyle} aria-labelledby="upcoming-appointments-title">
            ...
            <AppointmentList appointments={upcomingAppointments} type="upcoming" onViewAppointment={handleViewAppointment} />
          </section>
          ...
          <section style={sectionCardStyle} aria-labelledby="past-appointments-title">
            ...
            <div style={{ maxHeight: 400, overflowY: "auto", paddingRight: 8 }}>
              <AppointmentList appointments={pastAppointments} type="past" userId={userId} onViewAppointment={handleViewAppointment} />
            </div>
          </section>
        </div>
