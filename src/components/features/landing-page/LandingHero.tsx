        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              Access all government services from one convenient platform. Apply
              for documents, pay bills, track applications, and connect with
              government departments seamlessly.
            </p>
