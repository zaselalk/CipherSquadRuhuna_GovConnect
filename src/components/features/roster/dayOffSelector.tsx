...
const DayOffSelector = ({ onClose, onSubmit }: any) => {
  ...
  const handleSelect = (date: Dayjs) => {
    ...
    setSelectedDates(
      exists ? selectedDates.filter(d => !d.isSame(date, "day")) : [...selectedDates, date]
    );
  };

  // Render day numbers with selection and disabled styles
      ...
      >
        <Calendar
          ...
          onPanelChange={(date) => {
            ...
            } else if (date.isAfter(maxDate, "month")) {
